...
public class BreakerTeleopController {
	...
	static Joystick L = new Joystick(1);
	static Joystick R = new Joystick(0);
...
//				DriveSystems.shifters.toggle();
			DriveActions.set(
					new RobotDriveSignal(Curve.getBezierCurve(L.getRawAxis(1), 0.45, 0.15, 1, 0.6), Curve.getBezierCurve(R.getRawAxis(1), 0.45, 0.15, 1, 0.6), 
							DriveUnit.percentOutput), true
					);
