...
public class _DriveConstants extends BreakerSubsystem.Constants {
	...
	public static final double _ticksPerRevolution = 3250; //(Encoder Tick) [Measure] Encoder Ticks Per Wheel Revolution
	public static final double _wheelBaseWidth = 2.179;	   //(Feet) [Measure] The Distance from the Left and Right Wheels
	
	//Speed Adjustments
	public static final double _rightAccount = 1.00; //(TalSpeed) [Measure] Multiple the right motor by (For Driving Straight)
