...
public class Constants {
	...
	public static final double _ticksPerRevolution = 4698.25181344; //(Encoder Tick) [Measure] Encoder Ticks Per Wheel Revolution
	...
	public static final class Drive {
		...
		public static final double _leftAccount  = 1; //(TalSpeed) [Measure] Multiple the left  motor by (For Driving Straight)
		
		public static final double _gyroAngle = 65;   //(Degrees) [Measure] Yaw Angle of Gyro (Athena is 65)
		
		public static final double _rampSeconds			= 0.2; //(Seconds) [Tune/Choose]
		...
		public static final double highDrivePidF = 1.32;
		public static final double highDrivePidP = 3.70;
		public static final double highDrivePidI = 0.00;
		public static final double highDrivePidD = 0.01;
		
		public static final int _lowPidId = 1;
		public static final double lowDrivePidF = 1.32;
		public static final double lowDrivePidP = 1.50;
	...
	public static final class Autonomous {
		...
		public static final int 	  _samples	 = Trajectory.Config.SAMPLES_HIGH; //(Other) [Choose] Affects speed and quality of Trajectory Generation
		public static final double 	  _dt 		 = 20.0; //(hz) [Choose] delta time of Trajectory (use 20.0)
		
		//Trajectory Folowing
		public static final double _tfB    = 1.0; //(None) [Tune/Choose] (Range: Great Than Zero) Increases/Decreases Correction
